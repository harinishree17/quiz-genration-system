 ...
 * @author harin
 */
public class rorwcag extends javax.swing.JFrame {
static polocag oli;
static finalscorecag hd;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       if(globe.rrw == 1){
        ...
        try{
            ...
            String sql1="select "+hyu+" from "+globe.cag_now+" where no = "+(globe.inc+1)+"";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        this.setVisible(false);
           ...
           new finalscorecag().setVisible(true);
        this.setVisible(false);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rorwcag.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
