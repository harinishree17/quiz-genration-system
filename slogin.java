...
static smenuopt ghi;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
                        ...
                        String sql="select exists( select id,pin from users where id = "+id+" and pin = "+pin+" and type = 'S' ) ";
			...
			con.close();
                         if(val == false)
        {
        JOptionPane.showMessageDialog(slogin.this, "CHECK YOUR PIN AND TRY AGAIN !!"," ERROR!", JOptionPane.ERROR_MESSAGE);
        }
        if(val == true){  
            globe.id = id;
