 ...
 * @author harin
 */
public class rorwgue extends javax.swing.JFrame {
static pologue oli;
static finalscoregue hd;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       if(globe.rrw == 1){
        ...
        try{
            ...
            String sql1="select "+hyu+" from "+globe.q_now+" where no = "+(globe.inc+1)+"";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        this.setVisible(false);
           ...
           new finalscoregue().setVisible(true);
        this.setVisible(false);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rorwgue.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
